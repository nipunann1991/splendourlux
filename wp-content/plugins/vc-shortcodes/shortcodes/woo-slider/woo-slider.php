    ...
    class ASVC_WooSlider {
		...
		vc_map( 
			array(
				...
				"description"			=> __( "Show latest products in Slider.", 'asvc' ),
            ...
            array(
                "type" => "hvc_notice",
                "class" => "",
                'heading' => __('<h3 class="hvc_notice" align="center">To get this powerful addon, please buy the pro version here <a target="_blank" href="https://themebon.com/items/visual-composer-shortcodes-pro/">Visual Composer Addons Pro</a> for only $11</h3>', 'hvc'),
